...
function OrdersModel () {
  this.createOrder = async function (label, sweet_type, flavor, quantity, filling, allergens, special_request, payment_method, delivery_date, client_id, address_id, client_id, address_id) {
